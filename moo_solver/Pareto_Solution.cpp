...
Pareto_Solution::Pareto_Solution(
    int node_id, const std::vector<std::pair<double, double>> &criteria,
    const std::vector<int> &dam_decisions,
    const std::vector<Pareto_Solution *> &pareto_decisions) : 
            node_id(node_id), criteria(criteria), dam_decisions(dam_decisions),
...
Pareto_Solution::Pareto_Solution(
    int node_id, const std::pair<double, double> *criteria, 
    const std::vector<int> &dam_decisions,
    const std::vector<Pareto_Solution *> &pareto_decisions,
    int num_criteria) : 
            node_id(node_id), dam_decisions(dam_decisions),
