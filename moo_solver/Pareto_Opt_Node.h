...
#ifndef MYANMAR_PROJECT_PARETO_OPT_NODE_H
#define MYANMAR_PROJECT_PARETO_OPT_NODE_H
...
public:
    ...
    Pareto_Opt_Node(double connectivity, double energy, int nodeID, double con_compare, 
                    double energy_compare,
                    std::vector<int> dam_decisions,
                    std::vector<Pareto_Opt_Node* > pareto_decisions);

    Pareto_Opt_Node(double connectivity, double energy, double sediment, double con_compare, 
                    double energy_compare,
...
#endif //MYANMAR_PROJECT_PARETO_OPT_NODE_H
