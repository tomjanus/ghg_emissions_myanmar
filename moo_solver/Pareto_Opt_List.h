...
#ifndef MYANMAR_PROJECT_PARETO_OPT_LIST_H
#define MYANMAR_PROJECT_PARETO_OPT_LIST_H
...
public:
    ...
    void add(double new_connectivity, double new_energy, int nodeID,
             ...
             // Note the representation of the variables will change
     ...
     */
    void add_round(double new_connectivity, double new_energy, double con_round, 
                   double energy_round, int nodeID,
                   std::vector<int> dam_decisions,
                   std::vector<Pareto_Opt_Node* > pareto_decisions);
    ...
    void add_multi(double true_con, double true_energy, double true_sed, 
                   double round_con, double round_energy,
...
private:
     ...
     */
    void add_helper(double con_compare, double energy_compare, double con_orig, 
                    double energy_orig, int nodeID,
                    std::vector<int> &dam_decisions,
                    std::vector<Pareto_Opt_Node* > &pareto_decisions);
...
#endif //MYANMAR_PROJECT_PARETO_OPT_LIST_H
