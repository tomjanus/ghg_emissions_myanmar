...
void Frontier_List::add_n_squared(const std::vector<std::pair<double, 
                                  double> > &criteria, int nodeID,
                                  const std::vector<int> &dam_decisions,
                                  const std::vector<Pareto_Solution *> &pareto_decisions) {
    Pareto_Solution *add_node = new Pareto_Solution(
        nodeID, criteria, dam_decisions, pareto_decisions);
...
void Frontier_List::add_n_squared(const std::pair<double, double> *criteria, 
                                  int nodeID,
                                  const std::vector<int> &dam_decisions,
                                  const std::vector<Pareto_Solution *> &pareto_decisions, 
                                  int num_solutions,
    ...
    Pareto_Solution *add_node = new Pareto_Solution(
        nodeID, criteria, dam_decisions, pareto_decisions, num_solutions);
    Pareto_Solution *curr = this->head->next;
    Pareto_Solution *prev = this->head;
