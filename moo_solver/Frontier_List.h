...
#ifndef MYANMAR_PROJECT_FRONTIER_LIST_H
#define MYANMAR_PROJECT_FRONTIER_LIST_H
...
public:
    ...
    */
     ...
     */
    void add_n_squared(const std::vector<std::pair<double, double> > &criteria, 
                       int nodeID,
...
#endif //MYANMAR_PROJECT_FRONTIER_LIST_H
